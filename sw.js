...
const CACHE_NAME = '5s-assessment-v3.0.6';
const ASSETS = [
  './',
  './index.html',
  './Index.html',
  './manifest.json',
  './audit5s-mode-gate.js',
